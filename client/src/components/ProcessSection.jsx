...
function ProcessSection() {
  return (
    <section id="process" className="scroll-mt-24 bg-brand-black py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <ol className="mx-auto mt-14 max-w-4xl">
          {processSteps.map((step, index) => (
            <li key={step.number} className="relative grid gap-5 pb-8 sm:grid-cols-[8rem_1fr] sm:gap-10">
              <div className="flex items-start gap-4 sm:block">
                <span className="font-mono text-4xl font-bold text-brand-yellow">{step.number}</span>
              ...
              <div className="border-l border-brand-yellow/30 pb-8 pl-6 sm:pl-10">
                ...
                <p className="mt-2 max-w-xl leading-7 text-brand-gray">{step.description}</p>
              </div>
